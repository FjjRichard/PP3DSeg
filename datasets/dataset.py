...
class Dataset(paddle.io.Dataset):
    ...
    Args:
        ...
        flipud(bool,optional):Whether to flip the image up and down
        ...
        Examples:
            ...
            transforms = T.Compose([T.RandomPaddingCrop(crop_size=(512,512)), T.Normalize()])
    ...
    def __getitem__(self, idx):
        ...
        im = self.readNii(image_path)
        label = self.readNii(label_path)
        if self.mode == 'test':
