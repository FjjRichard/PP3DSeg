...
from PP3DSeg.utils import TimeAverager, calculate_eta, resume, logger, worker_init_fn
from PP3DSeg.core.val import evaluate
...
def train(model,
    ...
    """
    model.train()
    nranks = paddle.distributed.ParallelEnv().nranks #1
